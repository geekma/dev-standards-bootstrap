...
[![Standards Version](https://img.shields.io/badge/Standards-v3.41.0-green.svg)](resources/DEVELOPMENT_STANDARDS.md)
...
└── resources/
    ...
    ├── DEVELOPMENT_STANDARDS.md             # Full standards document v3.41.0 (copied to docs/)
    ...
    └── templates/
        ...
        ├── entry                             # Change-entry skeletons (v3.41.0): the seven begin-required artifacts (→ docs/templates/entry/)
        ├── new-change.sh                   # Change-entry scaffolder (v3.41.0): dedicated-dir vs same-day-batch resolution (→ scripts/new-change)
        ...
        ├── uninstall-standards.sh          # One-step uninstall: tiered removal + marker-verified delete + backup-move for shared assets (v3.41.0)
