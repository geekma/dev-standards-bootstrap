...
[![Standards Version](https://img.shields.io/badge/Standards-v3.40.0-green.svg)](resources/DEVELOPMENT_STANDARDS.md)
...
| **Golden-Case Self-Tests** | `tests/run-tests.sh` regression-tests the gate and the installer (395 golden-case assertions) in throwaway git repos — bash + git only (§2.17.4) |
...
└── resources/
    ...
    ├── DEVELOPMENT_STANDARDS.md             # Full standards document v3.40.0 (copied to docs/)
    ...
    └── templates/
        ...
        ├── entry                             # Change-entry skeletons (v3.40.0): the seven begin-required artifacts (→ docs/templates/entry/)
        ├── new-change.sh                   # Change-entry scaffolder (v3.40.0): dedicated-dir vs same-day-batch resolution (→ scripts/new-change)
...
**Standards Version:** v3.40.0 | **Last Updated:** 2026-09-22 | **Maintainer:** [geekma](https://x.com/geekma) | **Email:** geekma@gmail.com
