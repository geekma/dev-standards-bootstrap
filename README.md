...
[![Standards Version](https://img.shields.io/badge/Standards-v3.55.0-green.svg)](resources/DEVELOPMENT_STANDARDS.md)
...
| **Golden-Case Self-Tests** | `tests/run-tests.sh` regression-tests the gate and the installer (534 golden-case assertions) in throwaway git repos — bash + git only (§2.17.4) |
...
└── resources/
    ...
    ├── DEVELOPMENT_STANDARDS.md             # Full standards document v3.55.0 (copied to docs/)
...
**Standards Version:** v3.55.0 | **Last Updated:** 2026-09-25 | **Maintainer:** [geekma](https://x.com/geekma) | **Email:** geekma@gmail.com
